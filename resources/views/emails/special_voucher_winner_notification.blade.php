...
@section('content')
    <div style="text-align: center; margin-bottom: 32px;">
        ...
        <p style="font-size: 1.25rem; color: #5A10AC; margin: 0 0 20px 0;">
            herzlichen Glückwunsch! 🎉 Du hast im Special Quiz der Badabing Gameshow
            {{ $user->liveShow->start_time ? ' am ' . $user->liveShow->start_time->format('d.m.Y') : '' }} einen
            {{ (int) ($user->specialGift->voucher_amount ?? 0) }}€ baaboo Gutschein gewonnen 🥳
        </p>
    </div>
