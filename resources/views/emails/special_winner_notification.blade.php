...
@section('content')
    <div style="text-align: center; margin-bottom: 32px;">
        ...
        <p style="font-size: 1.25rem; color: #5A10AC; margin: 0 0 20px 0;">
            Du hast im <span style="color: #FC6902; font-weight:bold;">Special Quiz</span> der
            <span style="color:#FC6902; font-weight:bold;">Badabing Game Show</span>
    ...
    <div
        ...
        <div style="font-weight: bold; color: #5A10AC; margin-bottom: 10px; font-size: 1.1rem;">
            Herzlichen Glückwunsch zu deinem Special-Quiz-Gewinn!
            Dein Preis:
            {{ $prizeWon }}
        </div>
        <p>
        ...
        <p>
            📸 Zeig's der Welt:<br>
            Du hast im Special Quiz der Badabing-Quizshow gewonnen! Mach einen Screenshot von dieser Mail und poste ihn in
            deiner Story bei Instagram! Vergiss nicht
            <a href="https://www.instagram.com/badabing.show/" target="_blank">@badabing.show</a> zu taggen!
        </p>
    </div>
