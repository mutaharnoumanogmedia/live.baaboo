            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
                        <div>
                            <div class="fw-bold">{{ $isGlobalView ? 'Live Show Participations' : 'Participating Players' }}</div>
                            <div class="text-muted small">
                                Showing all {{ $totalPlayers }} {{ $isGlobalView ? 'live show participations' : 'participating players' }} with DataTable search,
                            ...
                            <tbody>
                                @forelse ($players as $index => $player)
                                    ...
                                    <tr>
                                        ...
                                        @if ($isGlobalView)
                                            <td>
                                                <div class="fw-semibold">{{ $player->participant_live_show_title }}</div>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="{{ $isGlobalView ? 12 : 11 }}" class="text-center text-muted py-4">No players found.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
                                        ...
                                        <tbody>
                                            @forelse ($specialPlayers as $index => $player)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge {{ $pivot->is_online ? 'bg-success' : 'bg-secondary' }}">
                                                            {{ $pivot->is_online ? 'Online' : 'Offline' }}
                                                        </span>
                                                    </td>
                                                    <td>
                                                        @if ($isSpecialWinner)
                                                            <span class="badge bg-warning text-dark">Special Winner</span>
                                                        @else
                                                            <span class="text-muted">No</span>
                                                        @endif
                                                    </td>
                                                    <td>
                                                        ...
                                                        @if ($specialGift)
                                                            <div>
                                                                <span class="badge bg-warning text-dark">{{ ucfirst($specialGift->type) }}</span>
                                                                @if ($pivot->special_discount_code)
                                                                    <div class="small">{{ $pivot->special_discount_code }}</div>
                                                                @endif
                                                            </div>
                                                        @endif
                                                    </td>
                                                    ...
                                                    <td style="min-width: 190px;">
                                                        @foreach ($specialEmailTypes as $key => $email)
                                                            @if ($email['show'])
                                                                @php $state = $emailState($email['status'], $email['sent_at']); @endphp
                                                                <div class="d-flex align-items-center gap-1 mb-1 small">
                                                                    <span class="text-muted" style="min-width: 110px;">{{ $email['label'] }}:</span>
                                                                    @if ($state === 'sent')
                                                    ...
                                                    <td class="text-end">
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                <li>
                                                                    <a class="dropdown-item" href="{{ route('admin.players.show', $player->id) }}" target="_blank">
                                                                ...
                                                                @if ($isSpecialWinner)
                                                                    <li>
                                                                        <a class="dropdown-item" href="javascript:void(0)"
                                                                            ...
                                                                            <i class="fas fa-envelope me-1"></i> Manage Special Emails
                                                                        </a>
                                                                    </li>
                                                                @endif
                                                                @if ($isGlobalView)
                                                                    <li>
                                                                        <a class="dropdown-item"
                                                                            href="{{ route('admin.live-shows.stream-management', $rowLiveShowId) }}">
                                                                            <i class="fas fa-broadcast-tower me-1"></i> Open Live Show
                                                                        </a>
                                                                    </li>
                                                                @endif
                                                            </ul>
                                            ...
                                            @empty
                                                <tr>
                                                    <td colspan="{{ $isGlobalView ? 12 : 11 }}" class="text-center text-muted py-4">No special quiz players found.</td>
                                                </tr>
                                            @endforelse
                                        </tbody>
                                    </table>
